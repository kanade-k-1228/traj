  ...
  return (
    <div className="h-screen bg-gray-950 flex flex-col overflow-hidden">
      <div className="max-w-[1800px] mx-auto w-full flex flex-col h-full">
        {/* Header */}
        <div className="bg-gray-900 border-b border-gray-800 p-2 flex-shrink-0 flex items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-2 flex-1">
            {Object.entries(METHODS).map(([modeId, mode]) => (
              <button
                ...
                className={clsx(
                  "px-2.5 py-1.5 rounded-lg border-2 transition-all text-xs font-medium cursor-pointer",
          ...
          <div className="flex items-center gap-2 flex-1 justify-end">
            <button
              ...
              className={clsx(
                ...
                "font-medium py-1.5 px-2.5 rounded-lg",
        ...
        {/* Footer - Legend */}
        <div className="bg-gray-900 border-t border-gray-800 p-2 flex-shrink-0 flex flex-wrap items-center justify-center gap-x-6 gap-y-2 text-xs text-gray-400">
          <div className="flex items-center gap-1">
